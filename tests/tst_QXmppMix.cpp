...
// Combined test binary for the MIX (XEP-0369) parse/serialize tests. Merging
// tst_QXmppMixInvitation, tst_QXmppMixIq and tst_QXmppMixItems into one
// translation unit parses the shared Qt/QXmpp headers once instead of three
// times. Each original test keeps its own namespace; main() runs them in turn.
