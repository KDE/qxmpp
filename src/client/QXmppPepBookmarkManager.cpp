...
/*!
    ...
    Returns \c std::nullopt if the bookmarks are unknown, i.e. they have not been fetched yet or
    the last fetch failed. This is different from an empty list, which means that there are no
