...
public:
    ...
    const QList<QXmppDiscoIdentity> &ownIdentities() const;
    void setOwnIdentities(const QList<QXmppDiscoIdentity> &identities);

    const QList<QXmppDataForm> &ownDataForms() const;
    void setOwnDataForms(const QList<QXmppDataForm> &dataForms);
