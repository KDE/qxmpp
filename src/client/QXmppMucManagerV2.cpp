...
/*!
    ...
    QXmppMucManagerV2 requires QXmppPubSubManager and QXmppDiscoveryManager to be registered with
    the client. Add all three before connecting:
