...
/*!
    ...
    \section1 Moderation and affiliation management
    ...
    \section1 Participants and permissions
...
/*!
    Sets the \xep{0410}{MUC Self-Ping} silence \a threshold.

    After \a threshold of silence on a joined room, the manager sends an \xep{0199}{XMPP Ping}
    to the user's own occupant JID and interprets the response to detect silent server-side
...
/*!
    ...
    Fails if the service does not support \xep{0307}{Unique Room Names for Multi-User Chat} or returns an empty name.
