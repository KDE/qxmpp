...
class QXmppMucManagerV2 : public QXmppClientExtension, public QXmppPubSubEventHandler
{
    Q_OBJECT
...
public:
    ...
    Q_SIGNAL void bookmarksChanged(const QList<BookmarkChange> &bookmarkUpdates);
