...
/*!
    ...
    \section2 Behaviour in previous versions
...
public:
    /*!
        \typealias QXmppRosterManager::Result
    ...
    */
    ...
    /*! This signal is emitted when the presence of a particular \a bareJid and \a resource changes. */
    ...
    */
    ...
    /*!
        This signal is emitted when the roster entry of a particular \a bareJid is
        added as a result of roster push.
    */
    Q_SIGNAL void itemAdded(const QString &bareJid);

    /*!
        This signal is emitted when the roster entry of a particular \a bareJid
