...
/*!
    ...
    \c <item/> element inside the \c muc#user \c <x/> block of incoming MUC presences.
...
/*!
    Sets the MUC participant \a newItem.
...
/*! Sets the MUC \a history options for joining. Pass \c std::nullopt to clear. */
