...
/*!
    ...
    Adds a new field to the form if \c {!value.isNull()}.
*/
...
/*!
    ...
    Adds a new field to the form if \c {!value.isEmpty()}.
*/
...
/*!
    ...
    Adds a new field to the form if \c {optional.has_value()}.
*/
...
/*!
    ...
    Adds a new field to the \a form if \c {optional.has_value()}.
